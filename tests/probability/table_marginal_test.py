...
def test_marginals_names_table():
    ...
    table2 = table.group_by("X3")
    assert all(compare(table2.names, ["X1", "X2"]))

    table2 = table.group_by("X1", "X3")
    assert all(compare(table2.names, ["X2"]))

    table2 = table.group_by("X2", "X3")
    assert all(compare(table2.names, ["X1"]))
    ...
    table2 = table.group_by("W")
    assert all(compare(table2.names, ["Y", "Z"]))

    table2 = table.group_by("Y", "W")
    assert all(compare(table2.names, ["Z"]))

    table2 = table.group_by("Z", "W")
    assert all(compare(table2.names, ["Y"]))
...
def test_marginals_table():
    ...
    table2 = table.group_by("X1", "X2", "X4")
    assert all(compare(table2.keys(), [(1,), (2,)]))
    assert table2[1] == 64
    assert table2[2] == 72
    ...
    table2 = table.group_by("X4")
    table3 = table2.group_by("X3")
    table4 = table3.group_by("X2")
...
def test_marginal_by_name_table():
    ...
    table2 = table.group_by("Age", "Sex", "Etn")
    assert all(compare(table2.keys(), [(1,), (2,)]))
    assert table2[1] == 64
    assert table2[2] == 72
    ...
    # marginalize three times
    table2 = table.group_by("Etn")
    table3 = table2.group_by("Edu")
    table4 = table3.group_by("Sex")
    assert all(compare(table4.keys(), [("a",), ("b",)]))
    assert table4["a"] == 36
    assert table4["b"] == 100
